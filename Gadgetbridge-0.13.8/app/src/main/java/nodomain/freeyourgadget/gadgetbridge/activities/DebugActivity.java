...
import nodomain.freeyourgadget.gadgetbridge.service.btle.profiles.heartrate.RemoveFrustration;
...
public class DebugActivity extends GBActivity{
    ...
    private Button StopCountingHeartRate;
...
//                            public void run() {
//                                // your code here
//                                GB.toast(getContext(), "Measuring Heart rate please wait... ", Toast.LENGTH_SHORT, GB.INFO);
...
//                    }
//                };
//                final Handler heartrateCaller = new Handler();
//                heartrateCaller.postDelayed(new Runnable() {
//                    @Override
//                    public void run() {
//                        GB.toast(getContext(), "Measuring Heart rate please wait... ", Toast.LENGTH_SHORT, GB.INFO);
//                        GBApplication.deviceService().onHeartRateTest();
...
//                        GB.toast("Measuring heart rate, please wait...", Toast.LENGTH_LONG, GB.INFO);
//                        GBApplication.deviceService().onHeartRateTest();
////                        int heartRate = HeartRateProfile.get_heartRate();
////                        GB.toast(getContext(), "Heart rate :"+ heartRate, Toast.LENGTH_SHORT, GB.INFO);
////                        if (heartRate >= 130) {
////                            GB.toast(getContext(), "keep calm ", Toast.LENGTH_SHORT, GB.INFO);
////                            Intent i = new Intent(DebugActivity.this, RemoveFrustration.class);
////                            startActivity(i);
////                        }
//                    }
//                }, 5*1000);
